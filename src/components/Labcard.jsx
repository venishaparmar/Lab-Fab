  ...
  return (
    <div>
      <div className="card-list">
        <a href="#" className="card-item" onClick={() => handleCardClick("MA115", "Web Development Lab")}>
          <h2>MA115</h2>
          <h3>Web Development Lab</h3>
        </a>
        <a href="#" className="card-item" onClick={() => handleCardClick("MA113", "Designer Lab")}>
          <h2>MA113</h2>
          <h3>Designer Lab</h3>
        </a>
        <a href="#" className="card-item" onClick={() => handleCardClick("MA112", "Data Science Lab")}>
          <h2>MA112</h2>
